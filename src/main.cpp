...
uint256 hashGenesisBlock("0x8f3956eb0c8a8af84cf135839e82721db5d7a01e79dea89048464e04e5f6c76d");
...
const string strMessageMagic = "CryptoShekel Signed Message:\n";
...
static const int64 nTargetTimespan = 6 * 60 * 60; // CryptoShekel: 6 hour recalculations
static const int64 nTargetSpacing = 120; // CryptoShekel: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal cryptoshekel miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "CryptoShekel", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xf3f992d367a03a31139298a44916cc1d291d3bd2ef966c43595cb627d486dab7");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Arutz Sheva 27/Dec/2013 Hezbollah Denies it Killed Former Lebanese Minister";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1388209379; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1879851;

        if (fTestNet)
        {
            block.nTime    = 1388196314;
            block.nNonce   = 1478125;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x1ac0ed0bf8d3ccc22fc7a6c2f97ea84ff33e33d7a4a0643ecb2cf8731d7316f0"));
